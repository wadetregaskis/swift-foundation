...
private final class DataIOTests {
    ...
    @Test func writeAtomicWithoutOverwriting() throws {
        // Regression test for https://github.com/swiftlang/swift-foundation/issues/1098
        // Combining `.atomic` and `.withoutOverwriting` used to crash via fatalError;
        // it should instead behave like `.withoutOverwriting`: succeed when the
        // destination is absent, throw fileWriteFileExists when it is present.
